...
class App(tk.Frame):
    ...
    def initUI(self):
        ...
        self.viewport.grid(rowspan=7, column=2, padx=3, pady=4)
        ...
        #button_add_object = tk.Button(objects_frame, text='add new object', command=lambda: addObject(entry_x, entry_y, viewport, list_objects))
